...
class CashRegisterUtil extends Util
{
    ...
    public function getRegisterDetails($register_id = null)
    {
        ...
        $register_details = $query->select(
            ...
            DB::raw("SUM(IF(pay_method='ovo', IF(transaction_type='sell', amount, 0), 0)) as total_ovo"),
            ...
            DB::raw("SUM(IF(transaction_type='refund', IF(pay_method='ovo', amount, 0), 0)) as total_ovo_refund"),
