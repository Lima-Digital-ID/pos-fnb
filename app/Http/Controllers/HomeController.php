...
class HomeController extends Controller
{
    ...
    public function getTotals()
    {
        if (request()->ajax()) {
            ...
            $kasbon=$this->getTotalPengeluaran($start, $end, 'kasbon');
            $output['kasbon'] = $kasbon;

            $pengeluaran=$this->getTotalPengeluaran($start, $end, 'pengeluaran');
            $output['pengeluaran'] = $pengeluaran;

            return $output;
        }
    }

    private function getTotalPengeluaran($start, $end, $tipe){
