        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#psr_avg_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars" aria-hidden="true"></i> Rata-rata</a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="psr_avg_tab">
...
@section('javascript')
    <script src="{{ asset('js/report.js?v=10') }}"></script>
@endsection