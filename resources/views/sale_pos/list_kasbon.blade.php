...
<section class="content">
    <div class="row no-print">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => URL::current(), 'method' => 'get', 'id' => 'kasbon_form' ]) !!}
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' =>"List Kasbon" ])
...
<script>
    ...
    $(document).on('submit', '#kasbon_form', function(e) {
            e.preventDefault();
            updateKasbonReport();
        });
    function updateKasbonReport() {
        var data = {
        ...
        url_data = out.join('&');
        dt.ajax.url('/sells/jsonkasbon?' + url_data).load();
    }
