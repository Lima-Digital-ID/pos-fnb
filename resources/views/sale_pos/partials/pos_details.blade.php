		...
		<div class="panel panel-default">
			<div class="panel-body bg-gray disabled" style="margin-bottom: 0px !important">
				<table class="table table-condensed" 
					...
					<tr>
						<td>
							<div class="col-sm-2 col-xs-6 col-2px-padding" hidden>
							...
							<div class="col-sm-3 col-xs-12 col-2px-padding" hidden>
								<button type="button" 
									class="btn bg-red btn-block btn-flat btn-lg no-print pos-express-btn" 
									data-toggle="modal" data-target="#pengeluaran_modal"
									title="Pengeluaran" >
							...
							<div class="col-sm-3 col-xs-12 col-2px-padding">
								<button type="button"  
								class="btn bg-red btn-block btn-flat no-print" 
								data-toggle="modal" data-target="#pengeluaran_modal"
								title="Pengeluaran"  >
								<div class="text-center">
									<i class="fa fa-id-card-o" aria-hidden="true"></i>
								...
								<button type="button"  
								class="btn bg-blue btn-block btn-flat no-print" 
								data-toggle="modal" data-target="#setoran_modal"
								title="Setoran" >
								<div class="text-center">
							...
							<div class="col-sm-2 col-xs-12 col-2px-padding">
								<button type="button" class="btn bg-yellow btn-block btn-lg btn-flat no-print pos-express-btn" 
								data-toggle="modal" data-target="#kasbon_modal"
								title="Input Kasbon">
								<div class="text-center">
								...
								<button type="button" class="btn bg-yellow btn-block btn-lg btn-flat no-print pos-express-btn" style="display:none" 
								data-toggle="modal" data-target="#petty_modal"
							...
							<div class="col-sm-4 col-xs-12 col-2px-padding" hidden>
								<button type="button"  
								...
								@if(empty($pos_settings['disable_suspend']))
									<button type="button" 
									class="btn bg-red btn-block btn-flat btn-lg no-print pos-express-finalize pos-express-btn" 
