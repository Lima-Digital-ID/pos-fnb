<tr class="product_row" data-row_index="{{$row_count}}">
	<td>
		...
		<span class="text-link text-info cursor-pointer" @if($is_cg != 1) data-toggle="modal" data-target="#row_edit_product_price_modal_{{$row_count}}" @endif>
			{!! $product_name !!}
	...
	<td>
		...
		<input type="hidden" class="" name="products[{{$row_count}}][is_item_paket]" value="0">
