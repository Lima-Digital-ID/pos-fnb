...
<section class="content">
    <div class="row no-print">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => URL::current(), 'method' => 'get', 'id' => 'pengeluaran_form' ]) !!}
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' =>"List Pengeluaran" ])
...
<script>
    ...
    $(document).ready( function(){
        dt = $('#list_pengeluaran').DataTable({
                ...
                columns: [
                    ...
                    //     return (row.method == 'card' ? 'Kartu Kredit' : (row.method == 'bank_transfer' ? 'Transfer Bank' : ''));
                    // }},
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    // Update footer
                    $( api.column( 3 ).footer() ).html('Rp. '+formatRupiah(total));
                }
            });
        var detailRows = [];
    ...
    $(document).on('submit', '#pengeluaran_form', function(e) {
            e.preventDefault();
            updatePengeluaranReport();
        });
    function updatePengeluaranReport() {
        var data = {
        ...
        url_data = out.join('&');
        dt.ajax.url('/sells/jsonpengeluaran?' + url_data).load();
    }
