@extends('layouts.app')
@section('title', 'List Pengeluaran Sewa')
...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' =>"List Pengeluaran Sewa" ])
...
<div class="modal fade" tabindex="-1" role="dialog" id="pengeluaran_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => action('SellPosController@savePengeluaranDt', 2), 'method' => 'post']) !!}
...
<div class="modal fade" tabindex="-1" role="dialog" id="pengurangan_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Input Pengurangan Sewa</h4>
            </div>
            {!! Form::open(['url' => action('SellPosController@savePengeluaranDt', 2), 'method' => 'post']) !!}
            <div class="modal-body">
                <div class="form-group" {{$location_id != null ? 'hidden' : ''}}>
...
<script>
    ...
    $(document).ready( function(){
        dt = $('#list_pengeluaran').DataTable({
                processing: true,
                serverSide: true,
                "ajax": "/sells/jsonpengeluaran_dt/2",
                aaSorting : [1, 'desc'],
                columns: [
    ...
    function updateManajemenReport() {
        ...
        url_data = out.join('&');
        dt.ajax.url('/sells/jsonpengeluaran_dt/2?' + url_data).load();
    }
