        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::text('member_code', $contact->member_code, ['class' => 'form-control']); !!}
              </div>
          </div>
        </div>
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::date('exp_member_date', $contact->exp_member_date, ['class' => 'form-control']); !!}
              </div>
          </div>
        </div>
        <div class="col-md-4 customer_fields">
      ...
      <div class="col-md-3">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::date('birthday', $contact->birthday, ['class' => 'form-control', 'required', 'placeholder' => __('contact.mobile')]); !!}
            </div>
        </div>
      </div>
      <div class="col-md-3">
