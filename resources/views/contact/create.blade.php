  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="col-md-4" hidden>
        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              {!! Form::label('Member Code') !!}
              <div class="input-group">
                  <span class="input-group-addon">
                      <i class="fa fa-users"></i>
                  </span>
                  {!! Form::text('member_code', 0, ['class' => 'form-control']); !!}
              </div>
          </div>
        </div>
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              {!! Form::label('Member Expired') !!}
              <div class="input-group">
                  <span class="input-group-addon">
                      <i class="fa fa-users"></i>
                  </span>
                  {!! Form::date('exp_member_date', null, ['class' => 'form-control']); !!}
              </div>
          </div>
        </div>
        <div class="col-md-4 customer_fields" hidden>
      ...
      <div class="col-md-3">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('mobile', null, ['class' => 'form-control', 'onchange' => 'cekMobile(this.value)', 'required', 'placeholder' => __('contact.mobile')]); !!}
            </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::date('birthday', null, ['class' => 'form-control', 'required', 'placeholder' => __('contact.mobile')]); !!}
            </div>
        </div>
      </div>
