<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_ovo }}</span>
              </td>
            </tr>
            ...
            <tr  class="success">
              <td>
                Sisa Saldo Sebelumnya(cash):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $sisa_saldo['total_cash'] }}</span>
              </td>
            </tr>
            <tr  class="success">
              <td>
                Sisa Saldo Sebelumnya(not cash):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $sisa_saldo['total_not_cash'] }}</span>
              </td>
            </tr>
            <tr  class="warning">
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $pengeluaran->setoran_cash }}</span>
              </td>
            </tr>
            <tr  class="warning">
              <td>
                Total Setoran (bukan cash):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $pengeluaran->setoran_not_cash }}</span>
              </td>
            </tr>
            <tr  class="warning">
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $pengeluaran->pengeluaran_cash }}</span>
              </td>
            </tr>
            <tr  class="warning">
              <td>
                Total Pengeluaran (bukan cash):
              </td>
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $pengeluaran->pengeluaran_not_cash }}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $pengeluaran->total_petty }}</span>
              </td>
            </tr>
            <tr class="success">
              <th>
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash  + $sisa_saldo['total_cash'] - ($register_details->total_cash_refund + $pengeluaran->setoran_cash + $pengeluaran->pengeluaran_cash) }}</span></b>
              </td>
            </tr>
            <tr class="success">
              <th>
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cheque + $register_details->total_card + $register_details->total_bank_transfer + $register_details->total_ovo + $register_details->total_other + $sisa_saldo['total_not_cash'] - ($pengeluaran->setoran_not_cash + $pengeluaran->pengeluaran_not_cash) }}</span></b>
              </td>
            </tr>
          </table>
        </div>
      ...
      @php
        $total_ahir=$register_details->total_cheque + $register_details->total_card + $register_details->total_bank_transfer + $register_details->total_ovo + $register_details->total_other + $sisa_saldo['total_not_cash'] + $register_details->cash_in_hand + $register_details->total_cash  + $sisa_saldo['total_cash'] - ($register_details->total_cash_refund + $pengeluaran->setoran_cash + $pengeluaran->pengeluaran_cash + $pengeluaran->setoran_not_cash + $pengeluaran->pengeluaran_not_cash);
      @endphp
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('closing_amount', 'Total Ahir:*') !!}
              {!! Form::text('closing_amount', @num_format($register_details->total_sale), ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'cash_register.total_cash' ) ]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
