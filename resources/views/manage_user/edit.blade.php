            ...
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  {!! Form::select('location_id', $business_locations, $location_id, ['class' => 'form-control', 
                            ...
                            'id' => 'location_id', 
                            'onchange'  => 'getPegawai(this.value)',
                            'required', 'autofocus']); !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::select('id_pegawai', 
                            $pegawai_option, $user->id_pegawai, ['id' => 'id_pegawai', 'class' => 'form-control select2', 'placeholder' => 'Pilih Nama Pegawai']); !!}
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
