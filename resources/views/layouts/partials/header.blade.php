...
<header class="main-header no-print">
    <a href="/home" class="logo">
        ...
        <span class="logo-lg">POS FnB</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button"
                ...
                data-toggle="popover" data-trigger="click" data-content='@include(
                    'layouts.partials.calculator'
                )' data-html="true"
            ...
            @can('sell.create')
                <a href="{{ action('SellPosController@create') }}" title="POS" data-toggle="tooltip" data-placement="bottom"
