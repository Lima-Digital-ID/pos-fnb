      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ in_array($request->segment(1), ['akuntansi']) ? 'active active-sub' : '' }}">
            ...
            <ul class="treeview-menu">
              @can( 'akuntansi.akun' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == '' ? 'active active-sub' : '' }}">
              ...
              @can( 'akuntansi.jurnal' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'jurnal' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@jurnal')}}">
                ...
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'general-ledger' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@generalLedger')}}">
                      <i class="fa fa-id-card-o"></i>
                      <span class="title">
                          General Ledger
                      </span>
              ...
              @can( 'akuntansi.profit-loss' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'neraca' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@neraca')}}">
              ...
              @can( 'akuntansi.neraca' )
                <li class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'profit-loss' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@labaRugi')}}">
              ...
              @can( 'akuntansi.close-book' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'close-book' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@closeBook')}}">
              ...
              @endcan
              @can( 'akuntansi.rekap-pc' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'rekap-pc' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@rekapPc')}}">
                      <i class="fa fa-book"></i>
                      <span class="title">
                          Laporan Petty Cash
                      </span>
              ...
              @endcan
              @can( 'akuntansi.rekap-trx' )
                <li hidden class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'rekap-transaksi' ? 'active active-sub' : '' }}">
                  <a href="{{action('AkuntanController@rekapTransaksi')}}">
                      <i class="fa fa-book"></i>
                      <span class="title">
        ...
        @if(auth()->user()->can('supplier.view') || auth()->user()->can('customer.view') )
          <li class="treeview {{ in_array($request->segment(1), ['contacts', 'customer-group']) ? 'active active-sub' : '' }}" id="tour_step4">
            ...
            <ul class="treeview-menu">
              @can('supplier.view')
                <li class="{{ $request->input('type') == 'supplier' ? 'active' : '' }}"><a href="{{action('ContactController@index', ['type' => 'supplier'])}}"><i class="fa fa-star"></i> Supplier</a></li>
              @endcan
              ...
              @if(auth()->user()->can('supplier.create') || auth()->user()->can('customer.create') )
                <li hidden class="{{ $request->segment(1) == 'contacts' && $request->segment(2) == 'import' ? 'active' : '' }}"><a href="{{action('ContactController@getImportContacts')}}"><i class="fa fa-download"></i> @lang('lang_v1.import_contacts')</a></li>
              @endcan
        ...
        auth()->user()->can('stock-adjustments.create') )
          <li class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories', 'stock-adjustments']) ? 'active active-sub' : '' }}" id="tour_step5">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
              @can('product.create')
                <li hidden class="{{ $request->segment(1) == 'variation-templates' ? 'active' : '' }}"><a href="{{action('VariationTemplateController@index')}}"><i class="fa fa-circle-o"></i><span>@lang('product.variations')</span></a></li>
              @endcan
              @can('product.create')
                <li hidden class="{{ $request->segment(1) == 'import-products' ? 'active' : '' }}"><a href="{{action('ImportProductsController@index')}}"><i class="fa fa-download"></i><span>@lang('product.import_products')</span></a></li>
              @endcan
              @can('product.opening_stock')
                <li hidden class="{{ $request->segment(1) == 'import-opening-stock' ? 'active' : '' }}"><a href="{{action('ImportOpeningStockController@index')}}"><i class="fa fa-download"></i><span>@lang('lang_v1.import_opening_stock')</span></a></li>
              @endcan
              @can('product.create')
                <li hidden class="{{ $request->segment(1) == 'selling-price-group' ? 'active' : '' }}"><a href="{{action('SellingPriceGroupController@index')}}"><i class="fa fa-circle-o"></i><span>@lang('lang_v1.selling_price_group')</span></a></li>
              @endcan
              ...
              @endif
                <li class="{{ $request->segment(1) == 'stock-adjustments' ? 'active' : '' }}">
                  <a href="{{action('StockAdjustmentController@index')}}"><i class="fa fa-shopping-bag"></i> <span>Penyesuaian Stok</span></a>
                </li>
            </ul>
          </li>
        @endif
        ...
        <li class="treeview {{in_array($request->segment(1), ['purchases', 'purchase-return']) ? 'active active-sub' : '' }}" id="tour_step6">
          ...
          <ul class="treeview-menu">
            ...
            @endcan
            @can('purchase.update')
              <li hidden class="{{ $request->segment(1) == 'purchase-return' ? 'active' : '' }}"><a href="{{action('PurchaseReturnController@index')}}"><i class="fa fa-undo"></i> @lang('lang_v1.list_purchase_return')</a></li>
            @endcan
          </ul>
        </li>
        @endif
        ...
        @if(auth()->user()->can('sell.view') || auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access') )
          <li class="treeview {{  in_array( $request->segment(1), ['sells', 'pos', 'sell-return', 'ecommerce', 'kasbon', 'pengeluaran', 'setoran', 'booking', 'promo', 'discount']) ? 'active active-sub' : '' }}" id="tour_step7">
            ...
            <ul class="treeview-menu">
              @can('direct_sell.access')
                <li class="hidden {{ $request->segment(1) == 'sells' && $request->segment(2) == null ? 'active' : '' }}" ><a href="{{action('SellController@index')}}"><i class="fa fa-list"></i>@lang('lang_v1.all_sales')</a></li>
              @endcan
              <!-- Call superadmin module if defined -->
              @if(Module::has('Ecommerce'))
              ...
              @endif
              @can('direct_sell.access')
                <li class="hidden {{ $request->segment(1) == 'sells' && $request->segment(2) == 'create' ? 'active' : '' }}"><a href="{{action('SellController@create')}}"><i class="fa fa-plus-circle"></i>@lang('sale.add_sale')</a></li>
              @endcan
              @can('sell.view')
              ...
              @can('sell.create')
                ...
                <li hidden class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'drafts' ? 'active' : '' }}" ><a href="{{action('SellController@getDrafts')}}"><i class="fa fa-pencil-square" aria-hidden="true"></i>@lang('lang_v1.list_drafts')</a></li>

                <li hidden class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'quotations' ? 'active' : '' }}" ><a href="{{action('SellController@getQuotations')}}"><i class="fa fa-pencil-square" aria-hidden="true"></i>@lang('lang_v1.list_quotations')</a></li>
              @endcan
              @can('sell.view')
                <li hidden class="{{ $request->segment(1) == 'sell-return' && $request->segment(2) == null ? 'active' : '' }}" ><a href="{{action('SellReturnController@index')}}"><i class="fa fa-undo"></i>@lang('lang_v1.list_sell_return')</a></li>
              @endcan
              
              @can('discount.access')
                <li hidden class="{{ $request->segment(1) == 'discount' ? 'active' : '' }}" ><a href="{{action('DiscountController@index')}}"><i class="fa fa-percent"></i>@lang('lang_v1.discounts')</a></li>
              @endcan
              <li {{auth()->user()['role'] != 2 ? '' : 'hidden'}} class="{{ $request->segment(1) == 'promo' ? 'active' : '' }}" ><a href="{{action('PromoController@index')}}"><i class="fa fa-tag"></i>Promo</a></li>
              ...
              @endif
                <li class="{{ $request->segment(2) == 'booking'? 'active' : '' }}" ><a href="{{action('SellPosController@listAntrian')}}"><i class="fa fa-calendar-check-o"></i>Atur Booking</a></li>
            </ul>
          </li>
        @endif
        @can('spend')
        <li @if($user->location_id  == 4) hidden @endif class="treeview {{ $request->segment(1) == 'spend' ? 'active active-sub' : '' }}">
          <a href="#"><i class="fa fa-money" aria-hidden="true"></i> <span>Pengeluaran</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            @can('spend.other')
              <li class="{{ $request->segment(2) == 'manajemen'? 'active' : '' }}" ><a href="{{action('SellPosController@listPengeluaranOther')}}"><i class="fa fa-recycle"></i>Pengeluaran Manajemen</a></li>
              <li class="{{ $request->segment(2) == 'sewa'? 'active' : '' }}" ><a href="{{action('SellPosController@listSewa')}}"><i class="fa fa-recycle"></i>Pengeluaran Sewa</a></li>
              <li class="{{ $request->segment(2) == 'deposit'? 'active' : '' }}" ><a href="{{action('SellPosController@listDeposit')}}"><i class="fa fa-recycle"></i>Deposit, THR, Amortisasi</a></li>
            @endcan
              <li class="{{ $request->segment(2) == 'setoran'? 'active' : '' }}" ><a href="{{action('SellPosController@listSetoran')}}"><i class="fa fa-recycle"></i>Laporan Setoran</a></li>
              <li class="{{ $request->segment(2) == 'kasbon'? 'active' : '' }}" ><a href="{{action('SellPosController@listKasbon')}}"><i class="fa fa-money"></i>Laporan Kasbon</a></li>
              <li class="{{ $request->segment(2) == 'pengeluaran'? 'active' : '' }}" ><a href="{{action('SellPosController@listPengeluaran')}}"><i class="fa fa-recycle"></i>Laporan Pengeluaran</a></li>
          </ul>
        </li>
        @endcan
        ...
        <li class="treeview {{ $request->segment(1) == 'stock-transfers' ? 'active active-sub' : '' }}" hidden>
        ...
        @if(auth()->user()->can('purchase.view') || auth()->user()->can('purchase.create') )
        <li class="treeview {{ $request->segment(1) == 'stock-adjustments' ? 'active active-sub' : '' }}" hidden>
        ...
        <li class="treeview {{  in_array( $request->segment(1), ['expense-categories', 'expenses']) ? 'active active-sub' : '' }}" hidden>
        ...
        @can('account.access')
          @if(in_array('account', $enabled_modules))
            <li class="treeview {{ $request->segment(1) == 'account' ? 'active active-sub' : '' }}" hidden>
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['reports']) ? 'active active-sub' : '' }}" id="tour_step8">
            ...
            <ul class="treeview-menu">
              @can('profit_loss_report.view')
                <li hidden class="{{ $request->segment(2) == 'profit-loss' ? 'active' : '' }}" ><a href="{{action('ReportController@getProfitLoss')}}"><i class="fa fa-money"></i>@lang('report.profit_loss')</a></li>
              @endcan

              @can('purchase_n_sell_report.view')
                <li hidden class="{{ $request->segment(2) == 'purchase-sell' ? 'active' : '' }}" ><a href="{{action('ReportController@getPurchaseSell')}}"><i class="fa fa-exchange"></i>@lang('report.purchase_sell_report')</a></li>
              @endcan

              @can('tax_report.view')
                <li hidden class="{{ $request->segment(2) == 'tax-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getTaxReport')}}"><i class="fa fa-tumblr" aria-hidden="true"></i>@lang('report.tax_report')</a></li>
              @endcan

              @can('contacts_report.view')
                <li hidden class="{{ $request->segment(2) == 'customer-supplier' ? 'active' : '' }}" ><a href="{{action('ReportController@getCustomerSuppliers')}}"><i class="fa fa-address-book"></i>@lang('report.contacts')</a></li>

                <li hidden class="{{ $request->segment(2) == 'customer-group' ? 'active' : '' }}" ><a href="{{action('ReportController@getCustomerGroup')}}"><i class="fa fa-users"></i>@lang('lang_v1.customer_groups_report')</a></li>
              @endcan
              ...
              @can('stock_report.view')
                <li hidden class="{{ $request->segment(2) == 'lot-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getLotReport')}}"><i class="fa fa-hourglass-half" aria-hidden="true"></i>@lang('lang_v1.lot_report')</a></li>
              @endcan

              @can('trending_product_report.view')
                <li @if($user->location_id  == 4) hidden @endif class="{{ $request->segment(2) == 'trending-products' ? 'active' : '' }}" ><a href="{{action('ReportController@getTrendingProducts')}}"><i class="fa fa-line-chart" aria-hidden="true"></i>@lang('report.trending_products')</a></li>
              @endcan

              @can('stock_report.view')
                <li hidden class="{{ $request->segment(2) == 'stock-adjustment-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getStockAdjustmentReport')}}"><i class="fa fa-sliders"></i>@lang('report.stock_adjustment_report')</a></li>
              @endcan

              @can('purchase_n_sell_report.view')

                <li hidden class="{{ $request->segment(2) == 'items-report' ? 'active' : '' }}" ><a href="{{action('ReportController@itemsReport')}}"><i class="fa fa-tasks"></i>@lang('lang_v1.items_report')</a></li>
                ...
                <li hidden class="{{ $request->segment(2) == 'purchase-payment-report' ? 'active' : '' }}" ><a href="{{action('ReportController@purchasePaymentReport')}}"><i class="fa fa-money"></i>@lang('lang_v1.purchase_payment_report')</a></li>

                <li hidden class="{{ $request->segment(2) == 'sell-payment-report' ? 'active' : '' }}" ><a href="{{action('ReportController@sellPaymentReport')}}"><i class="fa fa-money"></i>@lang('lang_v1.sell_payment_report')</a></li>
              @endcan

              @can('expense_report.view')
                <li hidden class="{{ $request->segment(2) == 'expense-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getExpenseReport')}}"><i class="fa fa-search-minus" aria-hidden="true"></i></i>@lang('report.expense_report')</a></li>
              @endcan
              ...
              @can('sales_representative.view')
                <li hidden class="{{ $request->segment(2) == 'sales-representative-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getSalesRepresentativeReport')}}"><i class="fa fa-user" aria-hidden="true"></i>@lang('report.sales_representative')</a></li>
              @endcan

              @if(in_array('tables', $enabled_modules))
                @can('purchase_n_sell_report.view')
                  <li hidden class="{{ $request->segment(2) == 'table-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getTableReport')}}"><i class="fa fa-table"></i>@lang('restaurant.table_report')</a></li>
                @endcan
              @endif
              @if(in_array('service_staff', $enabled_modules))
                @can('sales_representative.view')
                <li hidden class="{{ $request->segment(2) == 'service-staff-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getServiceStaffReport')}}"><i class="fa fa-user-secret"></i>@lang('restaurant.service_staff_report')</a></li>
                @endcan
              @endif
              <li  @if($user->location_id  == 4) hidden @endif class="{{ $request->segment(2) == 'sell-trx-member' ? 'active' : '' }}" ><a href="{{action('ReportController@getRekapTrxMember')}}"><i class="fa fa-money"></i>Rekap Transaksi Member</a></li>
              <li  @if($user->location_id  == 4) hidden @endif class="{{ $request->segment(2) == 'promo-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getRekapPromo')}}"><i class="fa fa-money"></i>Rekap Promo</a></li>
              @can('report.trx_employee')
              <li class="{{ $request->segment(2) == 'count_trx' ? 'active' : '' }}" ><a href="{{action('ReportController@getCountTrxEmployee')}}"><i class="fa fa-money"></i>Rekap Transaksi Jasa Pegawai</a></li>
              @endcan
              @can('report.finance')
              <li  @if($user->location_id  == 4) hidden @endif class="{{ $request->segment(2) == 'report-month' ? 'active' : '' }}" ><a href="{{action('ReportController@getReportMonth')}}"><i class="fa fa-money"></i>Laporan Keuangan</a></li>
              @endcan
            </ul>
          </li>
        @endif
        ...
        @if(in_array('tables', $enabled_modules) && in_array('service_staff', $enabled_modules) )
          ...
          <li hidden class="treeview {{ $request->segment(1) == 'bookings'? 'active active-sub' : '' }}">
        ...
        @if(in_array('kitchen', $enabled_modules))
          <li hidden class="treeview {{ $request->segment(1) == 'modules' && $request->segment(2) == 'kitchen' ? 'active active-sub' : '' }}">
              <a href="{{action('Restaurant\KitchenController@index')}}"><i class="fa fa-fire"></i> <span>@lang('restaurant.kitchen')</span></a>
          </li>
        @endif
        @if(in_array('service_staff', $enabled_modules))
          <li hidden class="treeview {{ $request->segment(1) == 'modules' && $request->segment(2) == 'orders' ? 'active active-sub' : '' }}">
        ...
        @can('send_notifications')
          <li hidden class="treeview {{  $request->segment(1) == 'notification-templates' ? 'active active-sub' : '' }}">
        ...
        <li class="treeview @if( in_array($request->segment(1), ['business', 'tax-rates', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'subscription']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
          ...
          <ul class="treeview-menu" id="tour_step3">
            ...
            @can('invoice_settings.access')
              <li hidden class="@if( in_array($request->segment(1), ['invoice-schemes', 'invoice-layouts']) ) {{'active'}} @endif">
            ...
            @if(in_array('tables', $enabled_modules))
               @can('business_settings.access')
                <li hidden class="{{ $request->segment(1) == 'modules' && $request->segment(2) == 'tables' ? 'active' : '' }}">
            ...
            @if(in_array('modifiers', $enabled_modules))
              @if(auth()->user()->can('product.view') || auth()->user()->can('product.create') )
                <li hidden class="{{ $request->segment(1) == 'modules' && $request->segment(2) == 'modifiers' ? 'active' : '' }}">
