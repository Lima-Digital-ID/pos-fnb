    ...
    auth()->user()->can('akuntansi.neraca'))
                <li class="treeview {{ in_array($request->segment(1), ['akuntansi']) ? 'active active-sub' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        @can('akuntansi.akun')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == '' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.jurnal')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'jurnal' ? 'active active-sub' : '' }}">
                            ...
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'general-ledger' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.profit-loss')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'neraca' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.neraca')
                            <li
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'profit-loss' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.close-book')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'close-book' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.rekap-pc')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'rekap-pc' ? 'active active-sub' : '' }}">
                        ...
                        @can('akuntansi.rekap-trx')
                            <li hidden
                                class="{{ $request->segment(1) == 'akuntansi' && $request->segment(2) == 'rekap-transaksi' ? 'active active-sub' : '' }}">
    ...
    auth()->user()->can('roles.view'))
                <li
                    ...
                    <ul class="treeview-menu">
                        ...
                        @can('user.create')
                            <li
                                class="{{ $request->segment(1) == 'sales-commission-agents' ? 'active active-sub' : '' }}">
                        ...
                        @can('supplier.view')
                            <li class="{{ $request->input('type') == 'supplier' ? 'active' : '' }}"><a
                                    href="{{ action('ContactController@index', ['type' => 'supplier']) }}"><i
                                        class="fa fa-star"></i> Supplier</a></li>
                        @endcan
    ...
    auth()->user()->can('customer.create'))
                            <li hidden
                                ...
                                <a href="{{ action('ContactController@getImportContacts') }}"><i
                                        class="fa fa-download"></i> @lang('lang_v1.import_contacts')</a>
                            </li>
                        @endcan
                    ...
                    @can('product.view')
                        <li
                            ...
                            <a href="{{ action('ProductController@index') }}"><i
                                    class="fa fa-list"></i>@lang('lang_v1.list_products')</a>
                        </li>
                    @endcan
                    @can('product.create')
                        <li
                            ...
                            <a href="{{ action('ProductController@create') }}"><i
                                    class="fa fa-plus-circle"></i>@lang('product.add_product')</a>
                        </li>
                    @endcan
                    @can('product.view')
                        <li
                            ...
                            <a href="{{ action('LabelsController@show') }}"><i
                                    class="fa fa-barcode"></i>@lang('barcode.print_labels')</a>
                        </li>
                    @endcan
                    @can('product.create')
                        <li hidden class="{{ $request->segment(1) == 'variation-templates' ? 'active' : '' }}"><a
                                href="{{ action('VariationTemplateController@index') }}"><i
                                    class="fa fa-circle-o"></i><span>@lang('product.variations')</span></a></li>
                    @endcan
                    @can('product.create')
                        <li hidden class="{{ $request->segment(1) == 'import-products' ? 'active' : '' }}"><a
                                href="{{ action('ImportProductsController@index') }}"><i
                                    class="fa fa-download"></i><span>@lang('product.import_products')</span></a></li>
                    @endcan
                    @can('product.opening_stock')
                        <li hidden class="{{ $request->segment(1) == 'import-opening-stock' ? 'active' : '' }}"><a
                                href="{{ action('ImportOpeningStockController@index') }}"><i
                                    class="fa fa-download"></i><span>@lang('lang_v1.import_opening_stock')</span></a>
                        </li>
                    @endcan
                    @can('product.create')
                        <li hidden class="{{ $request->segment(1) == 'selling-price-group' ? 'active' : '' }}"><a
    ...
    auth()->user()->can('brand.create'))
                    ...
                    <li class="{{ $request->segment(1) == 'stock-adjustments' ? 'active' : '' }}">
                        <a href="{{ action('StockAdjustmentController@index') }}"><i
                                class="fa fa-shopping-bag"></i> <span>Penyesuaian Stok</span></a>
                    </li>
                </ul>
            </li>
        @endif
                    ...
                    @can('purchase.view')
                        <li
                            ...
                            <a href="{{ action('PurchaseController@index') }}"><i
                                    class="fa fa-list"></i>@lang('purchase.list_purchase')</a>
                        </li>
                    @endcan
                    @can('purchase.create')
                        <li
                            class="{{ $request->segment(1) == 'purchases' && $request->segment(2) == 'create' ? 'active' : '' }}">
                            <a href="{{ action('PurchaseController@create') }}"><i class="fa fa-plus-circle"></i>
                                @lang('purchase.add_purchase')</a>
                        </li>
                    @endcan
                    @can('purchase.update')
                        <li hidden class="{{ $request->segment(1) == 'purchase-return' ? 'active' : '' }}"><a
            ...
            <li class="treeview {{ in_array($request->segment(1), ['sells','pos','sell-return','ecommerce','kasbon','pengeluaran','setoran','booking','promo','discount'])? 'active active-sub': '' }}"
                ...
                <ul class="treeview-menu">
                    @can('direct_sell.access')
                        <li
                            class="hidden {{ $request->segment(1) == 'sells' && $request->segment(2) == null ? 'active' : '' }}">
                            <a href="{{ action('SellController@index') }}"><i
                                    class="fa fa-list"></i>@lang('lang_v1.all_sales')</a>
                        </li>
                    @endcan
                    <!-- Call superadmin module if defined -->
                    @if (Module::has('Ecommerce'))
                    ...
                    @can('direct_sell.access')
                        <li
                            class="hidden {{ $request->segment(1) == 'sells' && $request->segment(2) == 'create' ? 'active' : '' }}">
                            <a href="{{ action('SellController@create') }}"><i
                                    class="fa fa-plus-circle"></i>@lang('sale.add_sale')</a>
                        </li>
                    @endcan
                    @can('sell.view')
                        <li
                            class="{{ $request->segment(1) == 'pos' && $request->segment(2) == null ? 'active' : '' }}">
                            <a href="{{ action('SellPosController@index') }}"><i
                                    class="fa fa-list"></i>@lang('sale.list_pos')</a>
                        </li>
                    @endcan
                    @can('sell.create')
                        <li
                            class="{{ $request->segment(1) == 'pos' && $request->segment(2) == 'create' ? 'active' : '' }}">
                            <a href="{{ action('SellPosController@create') }}"><i
                                    class="fa fa-plus-circle"></i>@lang('sale.pos_sale')</a>
                        </li>
                        <li hidden
                            class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'drafts' ? 'active' : '' }}">
                            <a href="{{ action('SellController@getDrafts') }}"><i class="fa fa-pencil-square"
                                    aria-hidden="true"></i>@lang('lang_v1.list_drafts')</a>
                        </li>

                        <li hidden
                            class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'quotations' ? 'active' : '' }}">
                            <a href="{{ action('SellController@getQuotations') }}"><i class="fa fa-pencil-square"
                                    aria-hidden="true"></i>@lang('lang_v1.list_quotations')</a>
                        </li>
                    @endcan
                    @can('sell.view')
                        <li hidden
                            ...
                            <a href="{{ action('SellReturnController@index') }}"><i
                                    class="fa fa-undo"></i>@lang('lang_v1.list_sell_return')</a>
                        </li>
                    @endcan

                    @can('discount.access')
                        <li hidden class="{{ $request->segment(1) == 'discount' ? 'active' : '' }}"><a
                                href="{{ action('DiscountController@index') }}"><i
                                    class="fa fa-percent"></i>@lang('lang_v1.discounts')</a></li>
                    @endcan
                    ...
                    @if (in_array('subscription', $enabled_modules))
                        <li class="{{ $request->segment(1) == 'subscriptions' ? 'active' : '' }}"><a
                                href="{{ action('SellPosController@listSubscriptions') }}"><i
                                    class="fa fa-recycle"></i>@lang('lang_v1.subscriptions')</a></li>
                    @endif
                    <li class="{{ $request->segment(2) == 'booking' ? 'active' : '' }}"><a
                            href="{{ action('SellPosController@listAntrian') }}"><i
                                class="fa fa-calendar-check-o"></i>Atur Booking</a></li>
                </ul>
            </li>
        @endif
        @can('spend')
            <li @if ($user->location_id == 4) hidden @endif
                class="treeview {{ $request->segment(1) == 'spend' ? 'active active-sub' : '' }}">
                ...
                <ul class="treeview-menu">
                    @can('spend.other')
                        <li class="{{ $request->segment(2) == 'manajemen' ? 'active' : '' }}"><a
                                href="{{ action('SellPosController@listPengeluaranOther') }}"><i
                                    class="fa fa-recycle"></i>Pengeluaran Manajemen</a></li>
                        <li class="{{ $request->segment(2) == 'sewa' ? 'active' : '' }}"><a
                                href="{{ action('SellPosController@listSewa') }}"><i
                                    class="fa fa-recycle"></i>Pengeluaran Sewa</a></li>
                        <li class="{{ $request->segment(2) == 'deposit' ? 'active' : '' }}"><a
                                href="{{ action('SellPosController@listDeposit') }}"><i
                                    class="fa fa-recycle"></i>Deposit, THR, Amortisasi</a></li>
                    @endcan
                    <li class="{{ $request->segment(2) == 'setoran' ? 'active' : '' }}"><a
                            href="{{ action('SellPosController@listSetoran') }}"><i
                                class="fa fa-recycle"></i>Laporan Setoran</a></li>
                    <li class="{{ $request->segment(2) == 'kasbon' ? 'active' : '' }}"><a
                            href="{{ action('SellPosController@listKasbon') }}"><i
                                class="fa fa-money"></i>Laporan
                            Kasbon</a></li>
                    <li class="{{ $request->segment(2) == 'pengeluaran' ? 'active' : '' }}"><a
                            href="{{ action('SellPosController@listPengeluaran') }}"><i
                                class="fa fa-recycle"></i>Laporan Pengeluaran</a></li>
                </ul>
            </li>
        @endcan
                    ...
                    @can('purchase.view')
                        <li
                            ...
                            <a href="{{ action('StockTransferController@index') }}"><i
                                    class="fa fa-list"></i>@lang('lang_v1.list_stock_transfers')</a>
                        </li>
                    @endcan
                    @can('purchase.create')
                        <li
                            ...
                            <a href="{{ action('StockTransferController@create') }}"><i
                                    class="fa fa-plus-circle"></i>@lang('lang_v1.add_stock_transfer')</a>
                        </li>
                    @endcan
                </ul>
            </li>
                ...
                <ul class="treeview-menu">
                    @can('purchase.view')
                        <li
                            ...
                            <a href="{{ action('StockAdjustmentController@index') }}"><i
                                    class="fa fa-list"></i>@lang('stock_adjustment.list')</a>
                        </li>
                    @endcan
                    @can('purchase.create')
                        <li
                ...
                <ul class="treeview-menu">
                    <li
                        ...
                        <a href="{{ action('ExpenseController@index') }}"><i
                                class="fa fa-list"></i>@lang('lang_v1.list_expenses')</a>
                    </li>
                    <li
                        class="{{ $request->segment(1) == 'expenses' && $request->segment(2) == 'create' ? 'active' : '' }}">
                        <a href="{{ action('ExpenseController@create') }}"><i
                                class="fa fa-plus-circle"></i>@lang('messages.add') @lang('expense.expenses')</a>
                    </li>
                    ...
                    <ul class="treeview-menu">
                        <li
                            ...
                            <a href="{{ action('AccountController@index') }}"><i
                                    class="fa fa-list"></i>@lang('account.list_accounts')</a>
                        </li>
                        ...
                        <li
                            ...
                            <a href="{{ action('AccountReportsController@balanceSheet') }}"><i
                                    class="fa fa-book"></i>@lang('account.balance_sheet')</a>
                        </li>
            ...
            <li class="treeview {{ in_array($request->segment(1), ['reports']) ? 'active active-sub' : '' }}"
                ...
                <ul class="treeview-menu">
                    @can('profit_loss_report.view')
                        <li hidden class="{{ $request->segment(2) == 'profit-loss' ? 'active' : '' }}"><a
                        ...
                        @if (session('business.enable_product_expiry') == 1)
                            <li class="{{ $request->segment(2) == 'stock-expiry' ? 'active' : '' }}"><a
                                    href="{{ action('ReportController@getStockExpiryReport') }}"><i
                                        class="fa fa-calendar-times-o"></i>@lang('report.stock_expiry_report')</a></li>
                        @endif
                    @endcan

                    @can('stock_report.view')
                        <li hidden class="{{ $request->segment(2) == 'lot-report' ? 'active' : '' }}"><a
                                href="{{ action('ReportController@getLotReport') }}"><i
                                    class="fa fa-hourglass-half" aria-hidden="true"></i>@lang('lang_v1.lot_report')</a>
                        </li>
                    @endcan
                    ...
                    @can('stock_report.view')
                        <li hidden class="{{ $request->segment(2) == 'stock-adjustment-report' ? 'active' : '' }}">
                            <a href="{{ action('ReportController@getStockAdjustmentReport') }}"><i
                                    class="fa fa-sliders"></i>@lang('report.stock_adjustment_report')</a>
                        </li>
                    @endcan

                    @can('purchase_n_sell_report.view')

                        <li hidden class="{{ $request->segment(2) == 'items-report' ? 'active' : '' }}"><a
                        ...
                        <li class="{{ $request->segment(2) == 'product-sell-report' ? 'active' : '' }}"><a
                                href="{{ action('ReportController@getproductSellReport') }}"><i
                                    class="fa fa-arrow-circle-up"></i>@lang('lang_v1.product_sell_report')</a></li>

                        <li hidden class="{{ $request->segment(2) == 'purchase-payment-report' ? 'active' : '' }}">
                            <a href="{{ action('ReportController@purchasePaymentReport') }}"><i
                                    class="fa fa-money"></i>@lang('lang_v1.purchase_payment_report')</a>
                        </li>

                        <li hidden class="{{ $request->segment(2) == 'sell-payment-report' ? 'active' : '' }}"><a
                    ...
                    @can('register_report.view')
                        <li class="{{ $request->segment(2) == 'product-purchase-report' ? 'active' : '' }}"><a
                                href="{{ action('ReportController@getproductPurchaseReport') }}"><i
                                    class="fa fa-arrow-circle-down"></i>@lang('lang_v1.product_purchase_report')</a>
                        </li>
                    ...
                    @if (in_array('tables', $enabled_modules))
                        @can('purchase_n_sell_report.view')
                            <li hidden class="{{ $request->segment(2) == 'table-report' ? 'active' : '' }}"><a
                    ...
                    @if (in_array('service_staff', $enabled_modules))
                        @can('sales_representative.view')
                            <li hidden
                                class="{{ $request->segment(2) == 'service-staff-report' ? 'active' : '' }}"><a
                                    href="{{ action('ReportController@getServiceStaffReport') }}"><i
                                        class="fa fa-user-secret"></i>@lang('restaurant.service_staff_report')</a></li>
                        @endcan
                    @endif
                    <li @if ($user->location_id == 4) hidden @endif
                        class="{{ $request->segment(2) == 'sell-trx-member' ? 'active' : '' }}"><a
                            href="{{ action('ReportController@getRekapTrxMember') }}"><i
                                class="fa fa-money"></i>Rekap Transaksi Member</a></li>
                    <li @if ($user->location_id == 4) hidden @endif
    ...
    auth()->user()->can('crud_own_bookings'))
                <li hidden
                    ...
                    <a href="{{ action('Restaurant\BookingController@index') }}"><i
                            class="fa fa-calendar-check-o"></i> <span>@lang('restaurant.bookings')</span></a>
                </li>
            @endif
        @endif
        ...
        @can('send_notifications')
            <li hidden
                class="treeview {{ $request->segment(1) == 'notification-templates' ? 'active active-sub' : '' }}">
