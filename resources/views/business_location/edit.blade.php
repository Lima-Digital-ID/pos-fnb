        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Royalty Fee (%)') !!}
              {!! Form::number('royalty_fee', $location->royalty_fee, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Dividen Mitra (%)') !!}
              {!! Form::number('dividen_mitra', $location->dividen_mitra, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Dividen Coolio (%)') !!}
              {!! Form::number('dividen_bisnis', $location->dividen_bisnis, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
      <div class="clearfix"></div>
      <div class="col-md-12">
