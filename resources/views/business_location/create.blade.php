        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Royalty Fee (%)') !!}
              {!! Form::number('royalty_fee', 0, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Dividen Mitra (%)') !!}
              {!! Form::number('dividen_mitra', 0, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('Dividen Coolio (%)') !!}
              {!! Form::number('dividen_bisnis', 0, ['class' => 'form-control', 'placeholder' => 'Jumlah Persen']); !!}
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-12">
