<div id="preview_body" style="font-family:Arial Narrow">
@php
	$loop_count = 0;
@endphp
	...
	@while($details['qty'] > 0)
		...
		<div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
			...
			@if(!empty($print['business_name']))
				<b style="display: block !important; font-size : 12px" class="text-uppercase">{{$business_name}}</b>
			@endif
			...
			@if(!empty($print['name']))
				...
				<span class="display_currency" data-currency_symbol = true style="font-size : 11px">
