    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'report.trx_employee', in_array('report.trx_employee', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Rekap Transaksi Jasa Pegawai' }}
              </label>
            </div>
          </div> 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'report.finance', in_array('report.finance', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Laporan Keuangan' }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'spend', in_array('spend', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Pengeluaran' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'spend.other', in_array('spend.other', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Pengeluaran Lain2' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'spend.delete', in_array('spend.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Hapus Pengeluaran' }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.akun', in_array('akuntansi.akun', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'List Akun' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.profit-loss', in_array('akuntansi.profit-loss', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'laba rugi' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.add_transfer', in_array('akuntansi.add_transfer', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Tambah Transfer' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.jurnal', in_array('akuntansi.jurnal', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Jurnal' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.neraca', in_array('akuntansi.neraca', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Neraca' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.close-book', in_array('akuntansi.close-book', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Tutup Buku' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.rekap-pc', in_array('akuntansi.rekap-pc', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Rekap Petty Cash' }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'akuntansi.rekap-trx', in_array('akuntansi.rekap-trx', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ 'Rekap Transaksi Harian' }}
              </label>
            </div>
          </div>
        </div>
