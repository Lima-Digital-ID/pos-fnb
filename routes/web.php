...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('/contacts/cek-mobile', 'ContactController@cekMobile');
    ...
    Route::get('/spend/manajemen', 'SellPosController@listPengeluaranOther');
    Route::get('/spend/deposit', 'SellPosController@listDeposit');
    Route::get('/spend/sewa', 'SellPosController@listSewa');
    Route::get('/spend/pengeluaran', 'SellPosController@listPengeluaran');
    Route::get('/spend/setoran', 'SellPosController@listSetoran');
    Route::get('/spend/kasbon', 'SellPosController@listKasbon');
    Route::get('/sells/booking', 'SellPosController@listAntrian');
    Route::get('/sells/pengeluaran/{id}', 'SellPosController@detailPengeluaran');
    Route::get('/sells/deletepengeluaran/{id}', 'SellPosController@deletePengeluaran');
    Route::get('/sells/deletepengeluaran_dt/{id}', 'SellPosController@deletePengeluaranDt');
    Route::get('/sells/antrian', 'SellPosController@getListAntrian');
    Route::get('/sells/cek-list-antrian/{id}', 'SellPosController@cekListAntrian');
    // Route::get('/sells/json_kasbon', 'SellPosController@jsonKasbon');
    Route::get('/sells/get-promo/{id}', 'SellPosController@getPromo');
    Route::get('/sells/jsonsetoran', 'SellPosController@jsonSetoran');
    Route::get('/sells/jsonpengeluaran', 'SellPosController@jsonPengeluaran');
    Route::get('/sells/jsonkasbon', 'SellPosController@jsonKasbon');
    Route::get('/sells/jsonpengeluaran_dt/{type}', 'SellPosController@jsonPengeluaranDt');
    ...
    Route::post('/sells/pos/save-pengeluaran', 'SellPosController@savePengeluaran');
    Route::post('/sells/pos/save-pengeluaran-dt/{type}', 'SellPosController@savePengeluaranDt');
    Route::post('/sells/pos/input-setoran', 'SellPosController@inputSetoran');
    Route::post('/sells/pos/input-petty', 'SellPosController@inputPetty');
    Route::post('/sells/pos/input-kasbon', 'SellPosController@inputKasbon');
    Route::get('/sells/pos/get-saldo-all', 'SellPosController@getSaldoAll');
    Route::get('/sells/get_pegawai_by_location/{id}', 'SellPosController@getPegawaiByLocation');
    Route::post('/sells/setBooking', 'SellPosController@setBooking');
    Route::resource('pos', 'SellPosController');

    Route::resource('roles', 'RoleController');

    Route::resource('users', 'ManageUserController');
    Route::get('users/get-pegawai/{id}', 'ManageUserController@getPegawaiByLocation');
    ...
    Route::get('/reports/sell-trx-member', 'ReportController@getRekapTrxMember');
    Route::get('/reports/report-finance', 'ReportController@getReportFinance');
    Route::get('/reports/promo-report', 'ReportController@getRekapPromo');
    Route::get('/reports/detail-promo-use/{id}', 'ReportController@detailPromoUse');
    ...
    Route::group(['prefix' => 'akuntansi'], function () {
        ...
        Route::post('/storeakun', 'AkuntanController@storeAkun');
        Route::get('/getNoAkun/{id}', 'AkuntanController@getNoAkun');
        Route::get('/getLevel/{id}', 'AkuntanController@getLevel');
        Route::get('/jurnal', 'AkuntanController@jurnal');
        Route::post('/jurnal', 'AkuntanController@jurnal');
        Route::get('/neraca', 'AkuntanController@neraca');
        Route::post('/neraca', 'AkuntanController@neraca');
        Route::get('/createjournal', 'AkuntanController@createJournal');
        Route::post('/storejournal', 'AkuntanController@storeJurnal');
        Route::get('/profit-loss', 'AkuntanController@labaRugi');
        Route::post('/profit-loss', 'AkuntanController@labaRugi');
        Route::get('/close-book', 'AkuntanController@closeBook');
        Route::post('/close-book', 'AkuntanController@closeBook');
        Route::get('/rekap-pc', 'AkuntanController@rekapPc');
        Route::post('/rekap-pc', 'AkuntanController@rekapPc');
        Route::get('/rekap-transaksi', 'AkuntanController@rekapTransaksi');
        Route::post('/rekap-transaksi', 'AkuntanController@rekapTransaksi');
        Route::post('/countRoyaltyFee', 'AkuntanController@countRoyaltyFee');
        Route::get('/general-ledger', 'AkuntanController@generalLedger');
        Route::get('/detail-gl/{id}', 'AkuntanController@detailGL');
        Route::post('/detail-gl/{id}', 'AkuntanController@detailGL');
        Route::post('/save_transfer_mitra', 'AkuntanController@saveTransferMitra');
        // Route::get('/orders/mark-line-order-as-served/{id}', 'Restaurant\OrderController@markLineOrderAsServed');
    });
    ...
    Route::get('bahan/limit-pemakaian', 'IngredientController@getLimitPemakaian');
